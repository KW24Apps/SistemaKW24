...
(function() {
    ...
    s.innerHTML = [
        '.content-area { overflow-y: auto !important; height: auto !important; max-height: none !important; }',
        '.finrel-panel { flex-shrink: 0 !important; }',
        '.finrel-panel-scroll { height: 260px !important; min-height: 260px !important; max-height: 260px !important; flex-shrink: 0 !important; overflow-y: auto !important; }'
    ].join(' ');
